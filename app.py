...
#removed below...never recognized in any project or follow along code I've ever used
...
app.config['SQLALCHEMY_DATABASE_URI'] = (
    os.environ.get('DATABASE_URL', 'postgresql:///warbler-unittest'))

app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False
app.config['SQLALCHEMY_ECHO'] = False
#removed due to see failing
...
def logout():
    ...
    #sigh...all I had to do was call do_logout()
    do_logout()
...
def homepage():
    ...
    """
    #testing session here...
    session["testing"] = "testingsession in / route"
...
#below is the add a like button handler
...
def add_message_like(message_id):
    ...
    try:
        ...
        if existing_like is None:
            ...
            flash("Alredy liked", "warning")
            print(f"{message_id} like exists")  #edit this to print out the user, like, and message in flask cons

        return redirect("/")
        
    except IntegrityError:
        db.session.rollback()
        flash("Error adding like", "danger")
        print(session["testing"])
        return redirect('/')
